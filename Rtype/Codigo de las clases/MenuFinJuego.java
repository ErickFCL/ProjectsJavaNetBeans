...
/**
 * Clase que extiende a JPanel y representa el menu del juego una vez que hayamos acabado, bien sea porque ganamos o porque nos mataron.
 * @version 1.0, 
...
public class MenuFinJuego extends JPanel {
	...
	public MenuFinJuego(JFrame f,boolean victoria){
		...
		if(victoria)
			label= new JLabel("Enhorabuena, ha acabado con todos los alien�genas!!");
		else
