...
public class Logica {
	...
	/*Mueve cada enemigo B a la izquierda y comprueba si ha sobrepasado la pantalla, volviendolo en su caso al otro extremo de pantalla, tambien 
	 comprueba que no salga por arriba o por abajo de la pantalla*/
